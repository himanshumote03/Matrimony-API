...
public class UserProfiles {
    ...
    // foreign key -> connected to id column in Users
    @ManyToOne(fetch = FetchType.EAGER)
    @JoinColumn(name = "user_id", referencedColumnName = "id")
    @JsonIgnoreProperties("user_profiles")
    private Users users;


    // foreign key -> join agency_id column to id column in Agencies Table
    @ManyToOne(fetch = FetchType.EAGER)
    ...
    // foreign key -> join blood_group_id column to id column in BloodGroup table
    @ManyToOne(fetch = FetchType.EAGER)
    ...
    // foreign key -> join gender_id column to id column in Gender table
    @ManyToOne(fetch = FetchType.EAGER)
    @JoinColumn(name = "gender_id", referencedColumnName = "id")
    @JsonIgnoreProperties("user_profiles")
    private Genders genders;

    // foreign key -> join marital_status_id column to id column in MaritalStatus table
    @ManyToOne(fetch = FetchType.EAGER)
    ...
    // foreign key -> join financial_satuses_id column to id column in FinancialStatuses table
    @ManyToOne(fetch = FetchType.EAGER)
    @JoinColumn(name = "financial_status_id", referencedColumnName = "id")
    @JsonIgnoreProperties("user_profiles")
    private FinancialStatuses financialStatuses;

    // foreign key -> join gotra_id column to id column in Gotras table
    @ManyToOne(fetch = FetchType.EAGER)
    ...
    public String toString() {
        return "UserProfiles{" +
                ...
                ", genders=" + genders +
                ", maritalStatusId=" + maritalStatuses +
                ", children=" + children +
